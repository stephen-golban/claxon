	...
	return (
		<Container loading={loading}>
			...
			<View className="gap-4">
				<Button onPress={() => router.push("/tabs")} variant="default" size="lg" className="rounded-full">
					<Text>Explore the app</Text>
				</Button>

				<Button onPress={() => router.push("/tabs/my-cars")} variant="outline" size="lg" className="rounded-full">
