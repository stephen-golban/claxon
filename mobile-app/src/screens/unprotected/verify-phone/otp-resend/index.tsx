	...
	return (
		...
		>
			{resendStatus === "success" && resendCooldown > 0 ? (
				...
				<Text
					className="text-center font-medium text-destructive group-active:text-destructive"
					disabled
				>
				...
				<View className="flex-row items-center gap-x-4">
					<Text
						className="text-center font-bold text-foreground group-active:text-foreground"
						disabled
					>
