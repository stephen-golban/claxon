...
const BaseColorSelectField = React.forwardRef<View, BaseColorSelectFieldProps>(
  ({ label, value, error, onChange, placeholder, hideLabel = false, disabled = false, onBlur, onFocus }, ref) => {
    ...
    const [selectedColorIndex, setSelectedColorIndex] = React.useState<number>(getColorIndexFromValue(value));
