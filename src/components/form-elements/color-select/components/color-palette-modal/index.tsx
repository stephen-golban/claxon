...
const ColorPaletteModal: React.FC<ColorPaletteModalProps> = ({
	...
	const [innerSelectedIndex, setInnerSelectedIndex] =
		React.useState(selectedColorIndex);
	...
	return (
		...
		>
			<View className="flex-1 bg-background pt-14">
				...
				<ModalList
					selectedColorIndex={innerSelectedIndex}
					onColorSelect={(idx) => setInnerSelectedIndex(idx)}
				/>
				<ModalFooter
