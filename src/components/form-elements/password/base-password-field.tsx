...
} from "../text-field/base-text-field";

export interface BasePasswordFieldProps
	extends Omit<BaseTextFieldProps, "secureTextEntry"> {}

const BasePasswordField = React.forwardRef<
	React.ComponentRef<typeof BaseTextField>,
					...
					rightElement={
						<Pressable onPress={togglePasswordVisibility}>
							<Icon
								size={20}
								color={
									error ? "rgb(242, 62, 48)" : isDark ? "#e5e7eb" : "#1f2937"
								}
							/>
						</Pressable>
					}
